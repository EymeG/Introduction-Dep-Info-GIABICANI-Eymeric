...
void checkDynamicConstraint(Context* context,int particle_id); // Check if the particle from context whose particle_id is particle_id is in contact with another particle of context and savec Constraint data if True
